...
final class BoardPackageStoreTests: XCTestCase {
    func testStoreDiscoversDirectChildPackagesWithoutCatalogAndSortsThem() throws {
        ...
        let unionedFrame = firstHold.frame.rect
        XCTAssertEqual(unionedFrame.minX, 0.05, accuracy: 1e-9)
        XCTAssertEqual(unionedFrame.minY, 0.1, accuracy: 1e-9)
        XCTAssertEqual(unionedFrame.width, 0.4, accuracy: 1e-9)
