...
| The table rests to 4:00 after the seventh hang (2:53); the surrounding prose describes 3 minutes between sets. | The seventh-repetition timer uses the table's 2:53 recovery to the 4:00 mark and calls it the table's between-set recovery. | Both source expressions are recorded. No second 3-minute rest is added, and no attempt is made to reconcile the 7-second difference. |
