# Trango Rock Prodigy Forge — repaired v2
...
Revision: Rock Prodigy Forge, green two-piece version; not Training Center.

## Current asset
`trango-rock-prodigy-forge.glb` — SHA-256 `cb905fe6eaac9161b40e8e0f5d972343e424925316bf15d76e59e4e033adeaba`.

22 independently selectable physical contacts; 215,322 triangles; 172,792 vertex records; 8,141,552 bytes. Original export: 25,706,292 bytes and 251,748 triangles. File-size reduction: 68.3%.
...
Largest sampled two-way vertex/centroid deviation from this revision's source master: 0.094485 mm; budget 0.25 mm. This is a sampled comparison, not an analytic global Hausdorff certificate and not measurement against the physical product.

C1 sloper-junction edit using exact known loft rings; face/hold topology retained; recorded height calibration preserves overall dimensions.
...
Material: Moulded synthetic hold material, neutral green PBR; exact resin formulation not established.
Published dimensions (mm): [323.85, None, 133.35]; scope/order: Interpreted per-half width, unknown thickness, height.
Estimated calibration (mm), where recorded: not separately specified.

Eight small screw openings, four per half, plus one larger observed through-opening in each IMR pocket; the latter purpose is not established. No screws/backer/wall. Authored clear separation 152.4 mm (6 inches) within manual suggested initial range.
...
- Per-half depth and sculpted sections are photo-derived estimates; the published two dimensions do not identify axes explicitly.
- Outer pinch widths and sloper transitions are approximate sculpted reconstructions, not calibrated CAD.
- Hidden rear surface is simplified. Pinch grip combinations reference existing surfaces and do not create duplicate geometry.
