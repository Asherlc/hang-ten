# Frictitious DoorMount Pro 7 — repaired v2
...
Revision: Pro 7, current seven-type wood-board variant; not Pro 5.

## Current asset
`frictitious-doormount-pro-7.glb` — SHA-256 `8b639807ff660566dca2fd313f00abfadaae0bfbaf0c28ecbc82477f2732113f`.

13 independently selectable physical contacts; 102,538 triangles; 79,347 vertex records; 3,774,284 bytes. Original export: 15,759,912 bytes and 147,134 triangles. File-size reduction: 76.1%.
...
Largest sampled two-way vertex/centroid deviation from this revision's source master: 0.047472 mm; budget 0.25 mm. This is a sampled comparison, not an analytic global Hausdorff certificate and not measurement against the physical product.
...
Published dimensions (mm): [647.7, 57.15, 114.3]; scope/order: X width, Y thickness, Z height.
Estimated calibration (mm), where recorded: not separately specified.

Doorway clamp system. Export contains the wooden board and observed central opening/channel only. Clamp, pads and other external mounting components omitted.
...
- Small subpocket depth is an authored 40 mm estimate; pocket dimensions/radii are unmeasured.
- Rear is a photograph-informed simplified wood surface; bonded pads and clamp hardware are omitted.
