...
| Nature Climbing | Raw Hanger | [product](https://natureclimbing.com/products/raw-hanger): 10.5 x 10.5 x 3.5 cm portable board, with 20/15/10/6 mm edges and more than ten advertised grip/pinch positions.  Preserve the four named edges; enumerate the remaining contacts only by direct gallery review. | included |
| Nature Climbing | Stone Hanger (Granite, Beech, and Smoked editions) | [product](https://natureclimbing.com/products/stone-hanger-1): 10.5 x 10.5 x 3.5 cm portable board, 20/15/10/6 mm edges, and more than ten advertised positions.  The listed finish/material choices are variants of this physical revision; the Black Oak page is a material edition, not another package. | included |
...
| Captain Fingerfood | 360° Hangboard | [product](https://captainfingerfood.rocks/en/products/hangboard-360-togo): current 12 x 8 x 6 cm rope-suspended cube, 12 grip options including a 15 mm crimp, pinches, and jug. | included |
...
| AEVORN | Portable Wooden Hangboard Block | [product](https://theaevorn.com/portable-hangboard): 4.13 x 4.72 x 1.97 in, 290 g, rope/hand-held/mounted compact single-hand trainer, with 6/15/20 mm depths.  Its gallery is the inventory evidence for the orientations, so no unsighted extra contact is admitted. | included |
| Aelith | Cyclops Portable Hangboard | [product](https://aelithequipment.com/product/cyclops-portable-hangboard/): pocketable, corded, one-hand device with a 20 mm mono edge; current page presents an add-to-cart model selector. | included |
...
- Do not create a second package for the Nature Mini wood choices, Stone
  Hanger material/finish choices, or the Captain Fingerfood Lines edition.
- The Nature Raw Hanger and Stone Hanger pages say “more than 10” positions.
  Their product galleries are sufficient primary visual evidence to manually
  enumerate contacts, but the prose is not a license to fabricate a count.  A
  Task 2 operator must record the gallery-to-hold mapping before accepting a
  package; if a contact cannot be distinguished, omit/defer that revision.
...
| AEVORN | included | https://theaevorn.com/portable-hangboard |
| Aelith | included | https://aelithequipment.com/product/cyclops-portable-hangboard/ |
