...
The user requires at least two retained exact-revision visual sources per board before Astra resumes, with materially different angles where available. The current manufacturer 1000 Series page supplies one complete straight-on front image; no second full-board manufacturer angle was found. The packet therefore retains the following documented commerce-gap source from 9c Climbing, an authorized climbing retailer:

Both visual snapshots were retrieved 2026-09-09 in locale `en-GB`; exact page linkage, tier, angle, and geometric support limits are recorded below and in the packet.
...
| commerce gap | `.context/shaky-rat-beastmaker-1000/references/9c-beastmaker-1000-03.jpg` | `db2bdac139d56951a04d674020e1ab50d2f36c1cb40aed158838da4bce195356` | 1800 × 513 | elevated front oblique / slight top reveal | [9c Climbing 1000 Series](https://9cclimbing.com/fr/products/1000-series-hangboard) |

The 9c page title and image mark identify the same Beastmaker 1000 Series layout; it is not used to override dimensions, inventory, material, or other manufacturer claims. The front view supports complete visible inventory and relative front placement. The oblique supports visible top-plane and side-roundover continuity. Neither view establishes hidden back geometry, cavity sections, radii, or measured depth. Crops, duplicate views, search thumbnails, and ambiguous revision media were rejected.
