...
| 8 | 8 s bent-arm hang (elbows @ 90), round slopers (3) → `round-sloper-3-left/right` | 30 s dead hang deep pockets (7) → `edge-7-left/right` | 20 s slightly bent-arm hang shallow 3 finger pocket (8), **stay on**; bump to x-deep three finger pockets (position 9); 25 s dead hang → `pocket-8-left/right`; `pocket-9-left/right` |
...
| 10 | Dead hang **to failure**, any holds → any Simulator 3D hold | 5 pull-ups deep edges (7), **without dropping off**, bump up to round slopers (3) & dead hang **till failure** → `edge-7-left/right`; `round-sloper-3-left/right` | 8 fast pull-ups jugs (1) (**keeping form perfect**); dead hang round sloper **to failure** (“fighting hard!”) → `jug-1-left/right`; `round-sloper-3-left/right` |
