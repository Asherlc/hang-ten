...
Checked 2026-08-12. This historical audit preserves the first-party material
reviewed for these four models. The old incomplete package art was removed and
is not an input to future work. Future geometry is directly authored from the
model's primary evidence under `docs/ADDING_A_BOARD.md`.
