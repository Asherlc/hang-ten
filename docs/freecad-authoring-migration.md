...
- conflicts between web, `board.json`, and mesh are recorded (URL + what it
  supports + what disagrees), not silently resolved by inventing facts;
...
### 5. Write the native checks before trusting anything
