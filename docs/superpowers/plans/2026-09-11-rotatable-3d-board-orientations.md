...
- [x] Re-read the spec section-by-section and map each acceptance criterion to Tasks 1–7, including Task 7's iOS simulator visual validation; verify no board-ID conditional, USDZ/descriptor edit, invented provenance, orientation+suspension combination, arbitrary pivot, or incomplete hold coverage exists.
