...
- [x] **Step 1: Write failing persistence and raw-packet tests**
...
- [x] **Step 3: Implement granular capture and persistence**
...
- [x] **Step 4: Add a read-only summary data-count cue**
