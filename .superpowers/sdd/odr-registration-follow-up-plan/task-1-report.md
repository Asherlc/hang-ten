...
- The parent project file contained 345 object definitions; the task commit contained 346. The historical task check counted the distinct object-definition IDs in the OpenStep `objects` dictionary, rather than every reference to an ID elsewhere in the project file.
