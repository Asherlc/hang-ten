...
class HoldDescriptorV1:
    ...
    def __init__(self, *_args: object, **_kwargs: object) -> None:
        raise TypeError("HoldDescriptorV1 is generated by descriptor factories")
...
class ModelDescriptorV1:
    ...
    def _from_validated(
        ...
        object.__setattr__(descriptor, "holds", MappingProxyType(dict(holds)))
        return descriptor
    ...
    def from_json(cls, value: Mapping[str, object]) -> ModelDescriptorV1:
        ...
        return cls._from_validated(model_sha256, model_bounds, nodes, holds)
...
def _compile_holds(
    ...
    for hold_id in sorted(node_ids_by_hold):
        ...
        result[hold_id] = HoldDescriptorV1._from_validated(
            tuple(sorted(node_ids_by_hold[hold_id])),
            face_bounds,
            (
...
def _parse_holds(value: object, nodes: Sequence[NodeBinding]) -> dict[str, HoldDescriptorV1]:
    ...
    for hold_id, raw_hold in holds.items():
        ...
        parsed[hold_id] = HoldDescriptorV1._from_validated(
